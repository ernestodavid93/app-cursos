<x-app-layout>
    <section class="bg-cover" style="background-image: url({{asset('img/cursos/software-developer.jpg')}})">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-36">
            <div class="w-full sm:w-1/2">
                    <h1 class="text-white font-bold text-4-1xl">Los mejores cursos de programacion</h1>
